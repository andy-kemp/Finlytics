...
// VNet for private endpoints and Function App integration
...
resource funcSubnet 'Microsoft.Network/virtualNetworks/subnets@2023-06-01' existing = {
  name: funcSubnetName
  parent: vnet
}

resource peSubnet 'Microsoft.Network/virtualNetworks/subnets@2023-06-01' existing = {
  name: pePESubnetName
  parent: vnet
}
...
resource sqlAzureServicesFirewall 'Microsoft.Sql/servers/firewallRules@2022-05-01-preview' = if (!enablePrivateEndpoints) {
