            ...
            <form onSubmit={handleSubmit} className="entity-form">
                ...
                <div className="form-row">
                    <div className="form-group">
                        <label>Company Inception Date</label>
                        <input
                            type="date"
                        ...
                        />
                        <small style={{color: '#666', fontSize: '0.85rem'}}>The date your company was established</small>
                    </div>
                </div>
                ...
                <div className="form-row">
                    <div className="form-group">
                        <label>Rate — First N miles (£/mile)</label>
                        <input
                            type="number"
                            name="amapRate45p"
                            value={settings.amapRate45p}
                            onChange={handleChange}
                            step="0.01"
                            min="0"
                            max="1"
                    ...
                    <div className="form-group">
                        ...
                        <input
                            ...
                            placeholder="0.25"
                        />
                        <small style={{color: '#666', fontSize: '0.85rem'}}>Default: 0.25 (25p/mile)</small>
                    </div>
                </div>
                <div className="form-row">
                    <div className="form-group">
                        <label>Mileage Threshold (miles)</label>
                        <input
                            type="number"
                            name="amapThresholdMiles"
                            value={settings.amapThresholdMiles}
                            onChange={handleChange}
                            step="1"
                            min="1"
                            placeholder="10000"
                        />
                        <small style={{color: '#666', fontSize: '0.85rem'}}>Default: 10,000 miles per tax year</small>
                    </div>
                </div>
